// Advent of Code 2017 Exercise 2
...
fn to_vec(s: &str) -> Vec<Vec<u32>> {
    let mut v: Vec<Vec<u32>> = Vec::new();
    for line in s.lines() {
        let mut tmp: Vec<u32> = Vec::new();
        for num in line.split_whitespace() {
            tmp.push(num.parse::<u32>().unwrap());
        }
        v.push(tmp);
    }
    v
...
fn main() {
    ...
    let input: &'static str = "626	2424	2593	139	2136	163	1689	367	2235	125	2365	924	135	2583	1425	2502
